...
// from lxterminal.conf:
// fontname=UbuntuMono NF 12
// fontname=UbuntuMono Nerd Font Mono 11
static const char *fonts[]          = { "UbuntuMono NF:size=14:antialias=true:autohint=true" };

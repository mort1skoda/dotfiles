...
alias ecdh='cd /dat.mnt/dotfiles/.config/suckless/from.git/dmw_git && vim config.def.h '
...
#echo $DATE  
alias date='source .aliases && echo $DATE  sunrise:  sunset: '
...
alias tm="/dat.mnt/dotfiles/scripts/tmux.sh"
# tl = tmux list
alias tl='tmux ls'
